...
CPP = "$(ProgFiles)/MinGW64/bin/x86_64-w64-mingw32-g++.exe"
CC = "$(ProgFiles)/MinGW64/bin/x86_64-w64-mingw32-gcc.exe"
...
CXXFLAGS = $(CXXINCS) -std=c++11 -m32 -DMingwVer=471 -DEnvir=15 -DKPSTEDI_MODE=6 -DMsgLang=1 -DBUFFERSIZE=4096
CPPFLAGS = $(CXXFLAGS) 
CCFLAGS = $(CXXFLAGS) 
...
$(ObjDir)/tvxmlch.o: $(TevDir)/xml/tvxmlch.cpp
	$(CPP) -c $(TevDir)/xml/tvxmlch.cpp -o $(ObjDir)/tvxmlch.o $(CPPFLAGS)
...
$(ObjDir)/Md5.o: $(BaseDir)/common/Md5.cpp
	$(CPP) -c $(BaseDir)/common/Md5.cpp -o $(ObjDir)/Md5.o $(CPPFLAGS)
