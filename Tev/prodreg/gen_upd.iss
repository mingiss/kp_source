...
; -----------------------
; keliais gabalais:
;OutputDir = MTP5E_v1.01.1_atnaujinimas_gabalais

;OutputBaseFilename = MTP5E_v1.01.1
...
OutputBaseFilename = MTP5E_v1.01.1_atnaujinimas
...
begin
   ...
   if(upd_num < GetPrevUpdNum) then
   begin
      if(upd_num < 1) then
         MsgBox('Programa „' + GetFirstVerName + '” dar neádiegta', mbCriticalError, MB_OK)
      else
         MsgBox('„' + GetPrevVerName + '” dar neádiegtas', mbCriticalError, MB_OK);
