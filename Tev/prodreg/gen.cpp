...
(const unsigned char *)"; MIMOK_5-6",
(const unsigned char *)"; \'MIKO knyga V–VI klasei (MIMOK 5–6)",
(const unsigned char *)";",
(const unsigned char *)"",
(const unsigned char *)"",
...
(const unsigned char *)";OutputDir=MIMOK_5-6_v1.11.25_atmintukas\\Output_flash",
(const unsigned char *)"OutputDir=Output_flash_iso\\MIMOK 5–6",
(const unsigned char *)"",
(const unsigned char *)"OutputBaseFilename=Pradzia_MIMOK_5-6",
(const unsigned char *)"",
(const unsigned char *)"",
...
(const unsigned char *)"begin",
(const unsigned char *)"Result:=\'MIKO knyga V–VI klasei (MIMOK 5–6)\';",
(const unsigned char *)"end;",
(const unsigned char *)"",
(const unsigned char *)"",
...
(const unsigned char *)"begin",
(const unsigned char *)"",
(const unsigned char *)"   retv := \'MIMOK 5–6\';",
(const unsigned char *)"",
...
(const unsigned char *)"",
(const unsigned char *)"",
(const unsigned char *)"function GetAppPathStr(Param: String): String;",
(const unsigned char *)"begin",
(const unsigned char *)"Result := GetAppPath;",
(const unsigned char *)"end;",
(const unsigned char *)"",
(const unsigned char *)"",
