...
copy "%ProgramFiles%\Inno Setup 5\Languages\Lithuanian_evad.isl" "%ProgramFiles%\Inno Setup 5\Default.isl" > nul
...
goto pabaiga
:noprompt_label
"%ProgramFiles%\Inno Setup 5\Compil32.exe" /cc gen_cd.iss
:pabaiga
