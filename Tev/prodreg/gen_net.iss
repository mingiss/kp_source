...
;OutputBaseFilename = MTP5E_v1.01.1_diegimas_tinkle
;OutputBaseFilename = MTP5E
;OutputBaseFilename = setup_net
...
Name: "{group}\Aktyvacija"; Filename: "{code:GetAppPathStr}\edini.exe"; Parameters: """{code:GetAppPathStr}\{code:GetExeFNameStr}.ini"""; IconFilename:"{code:GetAppPathStr}\setup01.ico"; WorkingDir: "{code:GetAppPathStr}";
