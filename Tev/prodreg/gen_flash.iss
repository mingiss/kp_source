...
OutputDir = .
;OutputDir = MTP5E_v1.01.1_atmintukas

;OutputBaseFilename = MTP5E_v1.01.1_diegimas_atmintuke
OutputBaseFilename = MTP5E_atmintuko_atstatymas
...
begin
Result := GetProdNameRaw + ' atmintuke';
end;
