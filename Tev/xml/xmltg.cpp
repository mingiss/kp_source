// ==================================================
// xmltg.cpp
// SGML dictionary tags
// lokalus tvxmltg.cpp variantas
// <se> perkeltas i <hg>
//
...
// --------------------------------------------------
const unsigned char *plpszaSgmDictTags[XC_TG_NumOfDictTagsArr68+1] = // Dictionary XML tag names with sgml Tage tags
{
  (unsigned char *)"<di>\n\n",
                // "<di name=\"%s\">\n\n",
                                                // XC_Dict
  ...
  (unsigned char *)"", // "<se>\n",             // XC_StEntry,
//                 "<se id=\"%ld\">"
  (unsigned char *)"\n", // "</se>\n\n",        // XC_StEntry_e, // negali buti "" - reiks "single tag"
...
//                 "<xr href=\"%s#%ld\">" // TV_XM_HrefDelim // TV_HTM_HrefDelim
  ...
  (unsigned char *)"</v>",                      // XC_Variant_e,  space after not allowed - may be inside of parentheses
  ...
  (unsigned char *)"</le>",                     // XC_Example_e,  space after not allowed - may be inside of parentheses
...
//                 "<s2 num=\"%ld\">"
  ...
  (unsigned char *)"</vn>",                     // XC_VarNorm_e,  space after not allowed - may be in parentheses
...
//                 "<s3 num=\"%s\">",
  ...
  (unsigned char *)"<s2c>",  // "<ss2>",        // XC_CpdMngGroup
  (unsigned char *)"</s2c>", // "</ss2>",       // XC_CpdMngGroup_e
  ...
  (unsigned char *)"<s2i>",  // "<sss2>",       // XC_IdMngGroup
  (unsigned char *)"</s2i>", // "</sss2>",      // XC_IdMngGroup_e

  (unsigned char *)"<xrx>",  // <!!!xr>",       // XC_Refinf
  (unsigned char *)"</xrx>", // </!!!xr>",      // XC_Refinf_e, space after not allowed - may be in free text
...
const int iaSgmDictCodeTables[XC_TG_NumOfDictTagsArr68] = // SGML Tage file code tables for Lizdynas
{
  0,    // XC_Dict,
  0,    // XC_Dict_e,
...
const int iaSgmDictCodeTablesEdi[XC_TG_NumOfDictTagsArr68] = // SGML Tage file code tables for editing with ZTEX
{
  0,    // XC_Dict,
  0,    // XC_Dict_e,
  TV_MAIN_SGME_CTBL,   // XC_NrtEntry,
  0,    // XC_NrtEntry_e,
  0,    // XC_StEntry,
  0,    // XC_StEntry_e,
  TV_MAIN_SGME_CTBL,   // XC_HeadWord,
  0,    // XC_HeadWord_e,
  TV_MAIN_SGME_CTBL,   // XC_Label,
  0,    // XC_Label_e,
  TV_MAIN_SGME_CTBL,   // XC_TrWord,
  0,    // XC_TrWord_e,
  TV_MAIN_SGME_CTBL,   // XC_UsNoteDst,
  0,    // XC_UsNoteDst_e,
  TV_MAIN_SGME_CTBL,   // XC_Reference,
  0,    // XC_Reference_e,
  TV_MAIN_SGME_CTBL,   // XC_StEntryText,
  0,    // XC_StEntryText_e,

  TV_MAIN_SGME_CTBL,   // XC_Paragraph,
  0,    // XC_Paragraph_e,
  ...
  TV_MAIN_SGME_CTBL,   // XC_Variant,
  0,    // XC_Variant_e,
  TV_MAIN_SGME_CTBL,   // XC_PartOfSpeechSrc,
  0,    // XC_PartOfSpeechSrc_e,
  ...
  TV_MAIN_SGME_CTBL,   // XC_FormDst,
  0,    // XC_FormDst_e,
  TV_MAIN_SGME_CTBL,   // XC_FormSrc,
  0,    // XC_FormSrc_e,

  TV_MAIN_SGME_CTBL,   // XC_ExplSrc,
  0,    // XC_ExplSrc_e,
  TV_MAIN_SGME_CTBL,   // XC_Example,
  0,    // XC_Example_e,

  0,    // XC_ExampleGroup,
  0,    // XC_ExampleGroup_e,

  TV_MAIN_SGME_CTBL,   // XC_Parenth,
  0,    // XC_Parenth_e,

  TV_MAIN_SGME_CTBL,   // XC_Idiom,
  0,    // XC_Idiom_e,
  ...
  TV_MAIN_SGME_CTBL,   // XC_Base,
  0,    // XC_Base_e,
  0,    // XC_CompoundGroup,
  0,    // XC_CompoundGroup_e,
  TV_MAIN_SGME_CTBL,   // XC_CompoundWord,
  0,    // XC_CompoundWord_e,
  ...
  TV_MAIN_SGME_CTBL,   // XC_CtrlSrc,
  0,    // XC_CtrlSrc_e,

  TV_MAIN_SGME_CTBL,   // XC_PrGroup,
  0,    // XC_PrGroup_e,
  82,   // XC_Pron,
  0,    // XC_Pron_e,

  TV_MAIN_SGME_CTBL,   // XC_Abbr,
  0,    // XC_Abbr_e,

  TV_MAIN_SGME_CTBL,   // XC_Hom,
  0,    // XC_Hom_e,

  TV_MAIN_SGME_CTBL,   // XC_ContextSrc,
  0,    // XC_ContextSrc_e,

  0,    // XC_CtrlGroup,
  0,    // XC_CtrlGroup_e,

  TV_MAIN_SGME_CTBL,   // XC_PartOfSpeechDst,
  0,    // XC_PartOfSpeechDst_e,
  ...
  TV_MAIN_SGME_CTBL,   // XC_VarNorm,
  0,    // XC_VarNorm_e,

  TV_MAIN_SGME_CTBL,   // XC_AbbrNorm,
  0,    // XC_AbbrNorm_e,
  ...
  TV_MAIN_SGME_CTBL,   // XC_Text
  0,    // XC_Text_e

  TV_MAIN_SGME_CTBL,   // XC_Info
  0,    // XC_Info_e

  TV_MAIN_SGME_CTBL,   // XC_Expand
  0,    // XC_Expand_e

  0,    // XC_StructGroup
  0,    // XC_StructGroup_e

  TV_MAIN_SGME_CTBL,   // XC_Gloss
  0,    // XC_Gloss_e

  TV_MAIN_SGME_CTBL,   // XC_FwNote
  0,    // XC_FwNote_e

  TV_MAIN_SGME_CTBL,   // XC_Italic
  0,    // XC_Italic_e

  TV_MAIN_SGME_CTBL,   // XC_ModCpdSrc
  0,    // XC_ModCpdSrc_e
  ...
  TV_MAIN_SGME_CTBL,   // XC_Super
  0,    // XC_Super_e

  0,    // XC_Count
  0,    // XC_Count_e

  TV_MAIN_SGME_CTBL,   // XC_HiLight
  0,    // XC_HiLight_e
  TV_MAIN_SGME_CTBL,   // XC_SemiBold
  0,    // XC_SemiBold_e

  TV_MAIN_SGME_CTBL,   // XC_CtrlDst
  0,    // XC_CtrlDst_e

  TV_MAIN_SGME_CTBL,   // XC_ExplNorm
  0,    // XC_ExplNorm_e

  TV_MAIN_SGME_CTBL,   // XC_Struct,
  0,    // XC_Struct_e,
  TV_MAIN_SGME_CTBL,   // XC_OblStruct,
  0,    // XC_OblStruct_e,

  TV_MAIN_SGME_CTBL,   // XC_Usage,
  0,    // XC_Usage_e,

  TV_MAIN_SGME_CTBL,   // XC_HBase,
  0,    // XC_HBase_e,

  0,    // XC_ModCpdGroup
  0,    // XC_ModCpdGroup_e

  TV_MAIN_SGME_CTBL,   // XC_ExampleTransl
  0,    // XC_ExampleTransl_e

  TV_MAIN_SGME_CTBL,   // XC_IdiomTransl
  0,    // XC_IdiomTransl_e

  TV_MAIN_SGME_CTBL,   // XC_TechNote
  0,    // XC_TechNote_e

  0,    // XC_IdMngGroup
  0,    // XC_IdMngGroup_e

  TV_MAIN_SGME_CTBL,   // XC_Refinf,
  0,    // XC_Refinf_e,

  TV_MAIN_SGME_CTBL,   // XC_SrcWord,
  0,    // XC_SrcWord_e,

  TV_MAIN_SGME_CTBL,   // XC_ModCpdDst
  0,    // XC_ModCpdDst_e

  TV_MAIN_SGME_CTBL,   // XC_ContextDst
  0,    // XC_ContextDst_e

  TV_MAIN_SGME_CTBL,   // XC_ExplDst
  0,    // XC_ExplDst_e

  TV_MAIN_SGME_CTBL,   // XC_RefWord
  0,    // XC_RefWord_e

  TV_MAIN_SGME_CTBL,   // XC_RefNum
  0,    // XC_RefNum_e

  TV_MAIN_SGME_CTBL,   // XC_RefXWord
  0,    // XC_RefXWord_e

  TV_MAIN_SGME_CTBL,   // XC_RefTab
  0,    // XC_RefTab_e

  TV_MAIN_SGME_CTBL,   // XC_RefPage
  0,    // XC_RefPage_e

  TV_MAIN_SGME_CTBL,   // XC_RefHom
  0,    // XC_RefHom_e

  TV_MAIN_SGME_CTBL,   // XC_SingleCpdWord
  0,    // XC_SingleCpdWord_e

  TV_MAIN_SGME_CTBL,   // XC_FormGroupDst
  0,    // XC_FormGroupDst_e

  TV_MAIN_SGME_CTBL,   // XC_DerivGroup
  0,    // XC_DerivGroup_e

  TV_MAIN_SGME_CTBL,   // XC_Derivative
  0,    // XC_Derivative_e

  TV_MAIN_SGME_CTBL,   // XC_StressParGroup
  0,    // XC_StressParGroup_e

  TV_MAIN_SGME_CTBL,   // XC_StressPar
  0,    // XC_StressPar_e

  TV_MAIN_SGME_CTBL,   // XC_PunctMark
  0,    // XC_PunctMark_e

  0,    // XC_LevelGroup
  0,    // XC_LevelGroup_e

  TV_MAIN_SGME_CTBL,   // XC_Level
  0,    // XC_Level_e

// TV_MAIN_SGME_CTBL,   // XC_TextExpr
// 0,    // XC_TextExpr_e

  TV_MAIN_SGME_CTBL,   // XC_UsNoteSrc,
  0,    // XC_UsNoteSrc_e,
  ...
  0,                 // XC_RefSecSynGr
  0,                 // XC_RefSecSynGr_e
  TV_MAIN_SGME_CTBL,  // XC_RefSecSyn
  0,                 // XC_RefSecSyn_e

  0,                 // XC_RefPriSynGr
  0,                 // XC_RefPriSynGr_e
  TV_MAIN_SGME_CTBL,  // XC_RefPriSyn
  0,                 // XC_RefPriSyn_e

  0,                 // XC_RefSynGr
  0,                 // XC_RefSynGr_e
  TV_MAIN_SGME_CTBL,  // XC_RefSyn
  0,                 // XC_RefSyn_e

  0,                 // XC_RefExamplGr
  0,                 // XC_RefExamplGr_e
  TV_MAIN_SGME_CTBL,  // XC_RefExampl
  0,                 // XC_RefExampl_e

  0,                 // XC_RefAntGr
  0,                 // XC_RefAntGr_e
  TV_MAIN_SGME_CTBL,  // XC_RefAnt
  0,                 // XC_RefAnt_e

  0,                 // XC_RefExamplSinglGr
  0,                 // XC_RefExamplSinglGr_e

  TV_MAIN_SGME_CTBL,   // XC_Subscript
  0,    // XC_Subscript_e

  TV_MAIN_SGME_CTBL,   // XC_CodeExampleInline
  0,    // XC_CodeExampleInline_e

  0,                 // XC_EnumGr
  0,                 // XC_EnumGr_e

  TV_MAIN_SGME_CTBL,  // XC_Enum
  0,                 // XC_Enum_e

  TV_MAIN_SGME_CTBL,   // XC_CodeBaseWord
  0,    // XC_CodeBaseWord_e

  TV_MAIN_SGME_CTBL,   // XC_CodeExample
  0,    // XC_CodeExample_e
  ...
  0,                  // XC_TableRow
  0,                  // XC_TableRow_e
  TV_MAIN_SGME_CTBL,  // XC_TableCell
  0,                  // XC_TableCell_e
  ...
  TV_MAIN_SGME_CTBL,  // XC_Special
  0,                  // XC_Special_e

  0,                  // XC_ExampleGroupForced
  0,                  // XC_ExampleGroupForced_e

  TV_MAIN_SGME_CTBL,  // XC_ExplForced
  0,                  // XC_ExplForced_e
  ...
  TV_MAIN_SGME_CTBL,  // XC_Page 
  0,                  // XC_Page_e 
  
  TV_MAIN_SGME_CTBL,  // XC_SemNr 
  0,                  // XC_SemNr_e 

  TV_MAIN_SGME_CTBL,  // XC_TrWordLit
  0,                  // XC_TrWordLit_e

  TV_MAIN_SGME_CTBL,  // XC_TrWordEng
  0,                  // XC_TrWordEng_e

  TV_MAIN_SGME_CTBL,  // XC_TrWordGer
  0,                  // XC_TrWordGer_e

  TV_MAIN_SGME_CTBL,  // XC_TrWordFre
  0,                  // XC_TrWordFre_e

  TV_MAIN_SGME_CTBL,  // XC_TrWordPol
  0,                  // XC_TrWordPol_e

  TV_MAIN_SGME_CTBL,  // XC_TrWordRus
  0,                  // XC_TrWordRus_e

  TV_MAIN_SGME_CTBL,  // XC_Species
  0,                  // XC_Species_e,

  0,    // XC_StructGroupForced
  0,    // XC_StructGroupForced_e

  TV_MAIN_SGME_CTBL,   // XC_VarBold
  0,    // XC_VarBold_e

  0,                  // XC_RefAntStrictGr
  0,                  // XC_RefAntStrictGr_e
  TV_MAIN_SGME_CTBL,  // XC_RefAntStrict
  0,                  // XC_RefAntStrict_e
};
