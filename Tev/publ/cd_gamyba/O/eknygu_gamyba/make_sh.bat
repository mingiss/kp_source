...
rem ---------------------------------
rem iskvietimas:
rem    call make_sh.bat [Publisher] [ProjID]
...
mkdir files_sh\DAT0
copy kpstart_cd_sh.ini files_sh\DAT0\sts.ini
:nodiag

echo copy kpstart_cd_sh.ini F:\kp\source\kpstart\kpstart.ini
copy kpstart_cd_sh.ini F:\kp\source\kpstart\kpstart.ini
