...
mkdir files_sh\DAT0
copy kpstart_cd_tux_sh.ini files_sh\DAT0\sts.ini
:nodiag

echo copy kpstart_cd_tux_sh.ini F:\kp\source\kpstart\kpstart.ini
copy kpstart_cd_tux_sh.ini F:\kp\source\kpstart\kpstart.ini
echo copy kpstart_cd_sh.ini F:\kp\source\kpstart\kpstreg.ini
copy kpstart_cd_sh.ini F:\kp\source\kpstart\kpstreg.ini
echo F:
F:
...
call F:\kp\source\kpstart\kpsttrg_s_mak.bat
