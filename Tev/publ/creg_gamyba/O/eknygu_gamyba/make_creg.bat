...
:: ---------------------------------
:: Iðkvietimas:
::    call make_creg.bat [Publisher] [ProjID] [ExeFName].pfx [Password]
::      ExeFName – sertifikato failo vardas 
::      Password – sertifikato slaptaþodis
:: Pvz.: 
::   call O:\eknygu_gamyba\make_creg.bat TEV MTP05_2015 b978_609_433_200_9.pfx 0kwSvQi97544U1mJ0E1L3w
