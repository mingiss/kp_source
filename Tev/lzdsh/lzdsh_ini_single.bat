echo //---------------------------- > %1_ini.cpp
echo // WinLED %2 .ini data >> %1_ini.cpp
echo // >> %1_ini.cpp
...
echo #include "kphp11y.h" >> %1_ini.cpp
echo #include "kphp11m.h" >> %1_ini.cpp
echo #include "kphp11w.h" >> %1_ini.cpp
echo #include "kphp11d.h" >> %1_ini.cpp
echo #include "kphp11rc.h" >> %1_ini.cpp
...
kpsfsz.exe %1.ini >> %1_ini.cpp
echo ]={ >> %1_ini.cpp
kpsdmp2.exe %1.ini 16 n b c >> %1_ini.cpp
echo }; >> %1_ini.cpp
